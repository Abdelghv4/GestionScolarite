...
require_once('identifier.php');
  ...
  if($idfiliere==0){
    $requeteEtudiant="select  idEtudiant,nom,prenom,civilite,annee_scolaire,nomFiliere,classe,resultat,photo
    ...
    &nbsp
      ...
      <?php } ?>
             ...
             <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Nº</th> <th>Nom</th><th>Prénom</th><th>Civilite</th><th>Année scolaire</th><th>Filière</th><th>Classe</th><th>Résultat</th><th>Photos</th>
                ...
                <tbody>
                        ...
                        <?php while($etudiant=$resultatEtudiant->fetch()){ ?>
                          ...
                          <a onclick="return confirm('Etes vous sur de vouloir supprimer ce etudiant?')" class="btn btn-danger btn-edit-delete"
                          href="supprimerEtudiant.php?idE=<?php echo $etudiant['idEtudiant'] ?>"> <span class="glyphicon glyphicon-trash"></span></a> &nbsp
