<?php
   require_once('identifier.php');
    ...
    $civilite=isset($_POST['civilite'])?$_POST['civilite']:"HOMME";
    ...
    $annee_scolaire=isset($_POST['anne_scolaire'])?$_POST['anne_scolaire']:"";
    ...
    move_uploaded_file($imageTemp,"../images/".$nomPhoto);
        ...
        $requete="insert into etudiant (nom,prenom,civilite,idFiliere,photo, date_naissance ,lieu_naissance ,adresse
         ,ville ,cin,tel_domicile ,tel_professionnel
          ,niveau_scolaire ,gmail ,dernier_etablissement ,num_inscription
          ,date_inscription ,code_massar ,resultat,annee_scolaire where idStagiaire)
          values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?";
