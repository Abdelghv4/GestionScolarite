    ...
    <div class="row my-row">
                            ...
                            <div class="row my-row">
								<label for="date_naissance"class="control-label col-sm-2"> Date de naissance:  </label>
									<div class="col-sm-4">								
								<input type="date" name="date_naissance"  id="date_naissance" class="form-control calendar"
                            ...
                            <div class="row my-row">
                             ...
                             <div class="row my-row">
								...
								value="<?php echo $tel_professionnel ?>"> 
									</div>
                             ...
                             <div class="row my-row">
								...
								value="<?php echo $dernier_etablissement ?>"> 
									</div>
								...
								value="<?php echo $num_inscription?>"> 
									</div>
                             ...
                             <div class="row my-row">
								...
								value="<?php echo $date_inscription?>"> 
									</div>

								<label for="code_massar"class="control-label col-sm-2"> Code massar:  </label>
									<div class="col-sm-4">
								<input type="text" name="code_massar" id="code_massar"class="form-control"
								value="<?php echo $code_massar?>"> 
									</div>
